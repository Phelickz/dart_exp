...
Options parseOptions(List<String> args) {
 final result =  _$populateOptionsParser.call(ArgParser()).parse(['help']);
  print('This is the second args: '+args.toString());
  // final result = _$parserForOptions.parse(["help"]);

  print('This is the result: ' +result.name.toString());
