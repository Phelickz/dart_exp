...
class JwtDate {
  ...
  ///
  /// Throws [JwtExpressException.invalidToken] if the value is not the correct type
  /// or is out of range.
  static DateTime? decode(dynamic? value) {
    if (value == null) {
      ...
      if (0 <= value) {
        ...
        throw JwtExpressException.invalidToken; // negative
      }
      ...
      if (value.isFinite && 0.0 < value) {
        ...
        throw JwtExpressException.invalidToken; // NAN, +ve infinity or negative
      }
    } else {
      throw JwtExpressException.invalidToken; // not an integer, nor a double
    }
  }
