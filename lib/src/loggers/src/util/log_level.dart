...
///
/// Log level for the logger is set up in [ExpressLoggy.initExpressLoggy] and it's used
/// for all new [ExpressLoggy].
/// Unless they are [ExpressLoggy.detached] or [hierarchicalLoggingEnabled]
